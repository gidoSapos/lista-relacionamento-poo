        ...
        while (true)
        {
            ...
            switch (opcao)
            {
                ...
                case 1:
                    ...
                    Temperatura temp1 = new Temperatura(); //objeto
                ...
                case 4:
                    ...
                    Console.WriteLine("Qual valor deseja utilizar?");
                    double valor = double.Parse(Console.ReadLine());
                    ContaBancaria conta = new ContaBancaria(0);

                    if (deseja == "D")
                    {
                        Console.WriteLine("Ativando modo depósito...");
                        conta.Depositar(valor);
                        Console.WriteLine($"Saldo atual: R${conta.Saldo}");
                    }
                    else if (deseja == "S")
                    {
                        Console.WriteLine("Ativando modo saque...");
                        conta.Sacar(valor);
                    }
                    else
                    {
                        Console.WriteLine("Opção inválida! Escolha 'D' para depositar ou 'S' para sacar.");
                    }
                    break;
                ...
                case 7:
                    ...
                    Console.WriteLine($"Você já viveu aproximadamente {pessoa.IdadeEmDias()} dias!");
                    break;
